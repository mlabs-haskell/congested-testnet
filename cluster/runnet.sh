...
sudo docker compose --file cluster/docker-compose-2.yaml down -v
...
sudo CARDANO_TAG=$CARDANO_TAG docker compose --file cluster/docker-compose-2.yaml up -d --remove-orphans --force-recreate --build
